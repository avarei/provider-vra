...
type TargetsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/avarei/provider-vra/v2/apis/namespaced/machine/v1alpha1.Machine
	...
	// +kubebuilder:validation:Optional
	MachineIDRef *v1.NamespacedReference `json:"machineIdRef,omitempty" tf:"-"`

	// Selector for a Machine in machine to populate machineId.
	// +kubebuilder:validation:Optional
	MachineIDSelector *v1.NamespacedSelector `json:"machineIdSelector,omitempty" tf:"-"`
