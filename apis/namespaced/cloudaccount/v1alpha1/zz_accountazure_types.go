...
type AccountAzureInitParameters struct {
	...
	// Azure Client Application Secret Key.
	ApplicationKeySecretRef v1.LocalSecretKeySelector `json:"applicationKeySecretRef" tf:"-"`
...
// AccountAzure is the Schema for the AccountAzures API. Creates a vra_cloud_account_azure resource.
