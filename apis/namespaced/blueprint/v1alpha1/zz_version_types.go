...
type VersionInitParameters struct {
	...
	BlueprintIDRef *v1.NamespacedReference `json:"blueprintIdRef,omitempty" tf:"-"`

	// Selector for a Blueprint to populate blueprintId.
	// +kubebuilder:validation:Optional
	BlueprintIDSelector *v1.NamespacedSelector `json:"blueprintIdSelector,omitempty" tf:"-"`
...
// Version is the Schema for the Versions API. A resource that can be used to create a VMware Aria Automation cloud template version.
